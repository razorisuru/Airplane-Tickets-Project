...
<html lang="en">
    ...
    <jsp:include page="IncludeHead.jsp">
        <jsp:param name="title" value="Airlines" />
    </jsp:include>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <jsp:include page="IncludeBreadCrumb.jsp">
                    <jsp:param name="path" value="Airlines" />
                </jsp:include>
                <!-- /.content-header -->
                                            ...
                                            <tbody>
                                                <%
                                                    try (Connection conn = DatabaseConnection.getConnection()) {
                                                        ...
                                                        String checkSql = "SELECT * FROM airline";
                                                        PreparedStatement checkStmt = conn.prepareStatement(checkSql);

                                                        ResultSet checkResult = checkStmt.executeQuery();

                                                        while (checkResult.next()) {
                                                            String id = checkResult.getString("airline_id");
                                                %>
                                                <tr>
                                                    <td><%= checkResult.getString("airline_id")%></td>
                                                    <td><%= checkResult.getString("name")%></td>
                                                    <td><%= checkResult.getString("seats")%></td>
                                                    <td>
                                                        <a class="btn btn-sm btn-danger" href="${pageContext.request.contextPath}/AirLineDeleteController?id=<%=id%>" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
                                                    </td> 
                                                </tr>
